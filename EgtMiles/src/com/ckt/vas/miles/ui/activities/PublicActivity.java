...
public class PublicActivity extends Activity implements OnTouchListener,
	...
	private void initMessages() {
		...
		messages.add(new ActivityMessage(R.drawable.andrew0, "Gauss",
				"张家界风景--武陵源", "真不错", R.drawable.fj1, 1333145510605l));
		...
		// img
		messages.add(new ActivityMessage(R.drawable.andrew0, "Andrew", "库仑咖啡",
				"真不错", R.drawable.coffe1, 1333163510605l));

		// friend
		messages.add(new ActivityMessage(R.drawable.andrew0, "Andrew", "Gauss",
				R.drawable.gauss1, 1333173510605l));
		...
		messages.add(new ActivityMessage(R.drawable.andrew0, "Andrew", "Gauss",
				R.drawable.gauss1, 1333170510605l));

		// img
		messages.add(new ActivityMessage(R.drawable.andrew0, "Andrew",
				"枫林晚纯真咖啡馆", "真不错", R.drawable.coffe0, 1333171510605l));
		messages.add(new ActivityMessage(R.drawable.gauss0, "Gauss",
